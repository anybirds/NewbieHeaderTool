...
void Group::Serialize(json &js, const Engine::Entity *entity) {
  ...
  js.push_back(e->scripts);
  js.push_back(e->renderers);
  js.push_back(e->drawers);
}
}
namespace Engine {
...
void Drawer::Deserialize(json &js, Engine::Entity *entity) {
  Drawer *e = (Drawer *)entity;
  e->order = js.back().get<unsigned int>(); js.erase(--js.end());
  Component::StaticType()->Deserialize(js, entity);
}
}
namespace Engine {
void AFramebuffer::Deserialize(json &js, Engine::Entity *entity) {
  AFramebuffer *e = (AFramebuffer *)entity;
  e->depthTexture = js.back().get<Engine::ATexture*>(); js.erase(--js.end());
  e->colorTexture = js.back().get<Engine::ATexture*>(); js.erase(--js.end());
...
void MeshDrawer::Deserialize(json &js, Engine::Entity *entity) {
  MeshDrawer *e = (MeshDrawer *)entity;
...
void AShader::Deserialize(json &js, Engine::Entity *entity) {
  ...
  e->shaderType = js.back().get<unsigned int>(); js.erase(--js.end());
  e->path = js.back().get<std::string>(); js.erase(--js.end());
  Asset::StaticType()->Deserialize(js, entity);
}
}
...
void ATexture::Deserialize(json &js, Engine::Entity *entity) {
  ...
  e->format = js.back().get<unsigned int>(); js.erase(--js.end());
...
void Group::Deserialize(json &js, Engine::Entity *entity) {
  ...
  e->drawers = js.back().get<std::multiset<Drawer *, DrawerComparer>>(); js.erase(--js.end());
  e->renderers = js.back().get<std::multiset<Renderer *, RendererComparer>>(); js.erase(--js.end());
  e->scripts = js.back().get<std::unordered_set<Script *>>(); js.erase(--js.end());
